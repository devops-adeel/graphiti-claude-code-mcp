...
## [1.0.1](https://github.com/yourusername/graphiti-claude-code-mcp/compare/v1.0.0..v1.0.1) - 2025-08-28


### 🐛 Bug Fixes

- *(network)* Enable flexible Docker networking configuration
## [1.0.0](https://github.com/yourusername/graphiti-claude-code-mcp/compare/v0.3.0..v1.0.0) - 2025-08-28

...
from langfuse_models import (
    LangfuseObservation, LangfuseTrace, DetectedPattern,
    TraceStatus, ObservationType, PhaseType, PatternConfidence,
    LangfuseScore
)
...
class LangfuseTestData:
    ...
    def create_detected_pattern(
        ...
        return {
            ...
            "confidence_level": (
                PatternConfidence.HIGH.value if confidence > 0.8
                else PatternConfidence.MEDIUM.value if confidence > 0.5
    ...
    class API:
        ...
        class Trace:
            ...
            def list(self, **kwargs):
                ...
                trace_dicts = [
                    self.api.client.all_scenarios.get(s, self.api.client.all_scenarios["normal"])
                ...
                for t in trace_dicts:
                    ...
                    for obs in t.get('observations', []):
                        obs_models.append(LangfuseObservation(
                            id=obs['id'],
                            name=obs.get('name'),
                    ...
                    for score in t.get('scores', []):
                        score_models.append(LangfuseScore(
                            name=score['name'],
                            value=score['value'],
                            trace_id=t['id']
                        ))
                    ...
                    # Create trace model
                    trace_models.append(LangfuseTrace(
                        id=t['id'],
                        name=t.get('name'),
